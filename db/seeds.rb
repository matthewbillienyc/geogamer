...
Datatype.create(dtype: 'language', lead_in: "The language of this country is ")
Datatype.create(dtype: 'life expectancy', lead_in: 'This country has a life expectancy of ')
...
Clue.create(location_id: 1, datatype_id: 4, data: '100%')
Clue.create(location_id: 1, datatype_id: 5, data: 'Norwegian')
Clue.create(location_id: 1, datatype_id: 6, data: '77 years')
