...
define('ember-cli-bootstrap/utils/test-breadcrumbs', ['exports'], function (exports) {
  'use strict';
  ...
  Bootstrap.BsBreadcrumbs = Bootstrap.ItemsView.extend(Bootstrap.WithRouter, {
    ...
    actions: {
      ...
      updateCrumbsByRoute: function updateCrumbsByRoute() {
        var routes,
            _this = this;
  ...
  exports['default'] = Bootstrap.BsBreadcrumbs;
});
...
define('ember-cli-bootstrap', ['ember-cli-bootstrap/index', 'ember', 'exports'], function(__index__, __Ember__, __exports__) {
  'use strict';
  var keys = Object.keys || __Ember__['default'].keys;
  var forEach = Array.prototype.forEach && function(array, cb) {
    array.forEach(cb);
